...
if(NOT EXISTS ${PWD}/gamsinclude.txt)
  if("${GAMS_PATH}" STREQUAL "")
    if(APPLE)
      string(CONCAT DISTIB_PATH
        "/Library/Frameworks/GAMS.framework/Versions/"
        "${GAMS_DISTRIB_MAJOR}/Resources")
      set(GAMS_DISTRIB DISTIB_PATH)
      set(GAMSINC "GAMS_DISTRIB=${GAMS_DISTRIB}")
    elseif(UNIX AND NOT APPLE)
      string(CONCAT DISTIB_PATH
        "$ENV{HOME}/gams/gams"
        "${GAMS_DISTRIB_MAJOR}.${GAMS_DISTRIB_MINOR}"
        "_linux_x64_64_sfx")
      set(GAMS_DISTRIB DISTIB_PATH)
      set(GAMSINC "GAMS_DISTRIB=${GAMS_DISTRIB}")
    elseif(WIN32)
...
if(EXISTS ${PWD}/gamsinclude.txt)
  read_from_file_and_set(${PWD}/gamsinclude.txt)
endif()
...
if("$ENV{GAMS_BUILD}" STREQUAL "")
  if(NOT EXISTS ${GAMS_DISTRIB_C_API})
    message(FATAL_ERROR "No GAMS found in path ${GAMS_DISTRIB}.
      GAMS is required to compile the C++ API.
      Please adjust ${CMAKE_SOURCE_DIR}/gamsinclude.txt
      to point to your GAMS installation.")
  endif()
  file(STRINGS "${CMAKE_CURRENT_SOURCE_DIR}/../gamsinclude.txt"
    GAMSINCLUDE LIMIT_COUNT 1)
...
if("$ENV{GAMS_BUILD}" STREQUAL "")
    ...
    configure_file(${GAMS_DISTRIB_CPP_API}/gamsoptionsimpl.cpp
      ${CMAKE_BINARY_DIR}/inc/gamsoptionsimpl.cpp COPYONLY)
    configure_file(${GAMS_DISTRIB_CPP_API}/gamsoptionsimpl.h
      ${CMAKE_BINARY_DIR}/inc/gamsoptionsimpl.h COPYONLY)
    configure_file(${GAMS_DISTRIB_CPP_API}/gamsoptions.cpp
      ${CMAKE_BINARY_DIR}/inc/gamsoptions.cpp COPYONLY)
    configure_file(${GAMS_DISTRIB_CPP_API}/gamsoptions.h
      ${CMAKE_BINARY_DIR}/inc/gamsoptions.h COPYONLY)

    set(SOURCE ${SOURCE}
      ${CMAKE_BINARY_DIR}/inc/gamsoptionsimpl.cpp
      ${CMAKE_BINARY_DIR}/inc/gamsoptions.cpp)
    set(HEADER ${HEADER}
      ${CMAKE_BINARY_DIR}/inc/gamsoptionsimpl.h
      ${CMAKE_BINARY_DIR}/inc/gamsoptions.h)
else()
    ...
    set(SOURCE ${SOURCE}
      ${GPRODUCTS_ENV}/apiexamples/C++/api/gamsoptions.cpp
